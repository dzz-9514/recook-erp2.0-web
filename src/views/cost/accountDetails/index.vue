...
<template>
  <div class="app-container">
    <pageMain>
      ...
      <template #sreach>
        <el-select placeholder="请选择交易类型">
          <el-option label="提现" :value='1' />
          <el-option label="收益" :value='2' />
        </el-select>
        <div class="mr-20">
          <formContent
            size="large"
        ...
        <el-input placeholder="请输入交易渠道"></el-input>
        <el-input placeholder="请输入目标户名"></el-input>
        <el-input placeholder="请输入目标账号"></el-input>
    ...
    <div class="p-all-20 bg-fff br-10 mt-20">
      ...
      >
        ...
        <template #action="{ row }">
          <akbutton cssType="3" @click="downLoad(row)">下载银行回单</akbutton>
        </template>
      </tableMain>
    </div>
  </div>
...
let columns = ref([
  { label: "交易类型", align: "center", slot: "name" },
  { label: "交易金额", align: "center", prop: "name_en" },
  { label: "交易时间", align: "center", slot: "pdf", width: 200 },
  { label: "交易渠道", align: "center", slot: "image" },
  { label: "目标户名", align: "center", slot: "order" },
  { label: "目标账号", align: "center", prop: "order" },
  { label: "流水号", align: "center", prop: "order" },
  { label: "操作", align: "center", slot: "action", width: 180 },
]);
